...
class Entity:
    ...
    def move_towards(self, target_x, target_y, game_map, entities):
        ...
        '''
        #Высчитывается синус и косинус угла между осью х и направлением
        на игрока и округляется к ближайшему целому.
        Таким образом, если синус > косинуса dx = 1, dy = 0 и наоборот
        '''
    ...
    def move_astar(self, target, entities, game_map):
        ...
        # be navigated around
        # Check also that the object isn't self or target ( so that
        # the start and the end points are free)
        ...
        # Allocate a A* path
        # The 1.41 is normal diagonal cost of moving, it can be set as 0.0 if
        # diagonal moves are prohibited
        my_path = tcod.path_new_using_map(fov, 1.41)

        # Compute the path between self's coordinates and the targets's
        # coordinates
